...
nlohmann::json XMLParser::XMLToJSON(const std::string& xml_string, SecurityRequest& request) {
  ...
  // Find our root node
    ...
    std::string result_node_name = result_node->name();
    if (result_node_name.compare("error") == 0) {
